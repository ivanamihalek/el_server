#! /usr/bin/perl -w
use DBI;
#use id2species; # I could not get this to work (Oct 2013) - suppose has something to do with how play works
sub set_id2species();
...
$query  = "SELECT protein_seq, exon_key, start_in_gene, is_canonical, ensembl_exon_id, source ";
...
while ( ($pepseq, $key,  $start, $is_canon, $ensembl_id, $source) = $sth->fetchrow_array) {
